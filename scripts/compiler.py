...
class Compiling(object):
	...
	def __init__(self, src_name, test_name):
		self.src = src_name
		self.test = test_name
		self.directory = '/Users/shiqi/Projects/funit'
	...
	def write_to_makefile(self):
		...
		self.makefile.write ('\n')
		self.makefile.write ('test.o: $(TEST_DIR)/%s.f90 src.o assert_class.o\n' % self.test)
		self.makefile.write ('\t$(FC) -c $(TEST_DIR)/%s.f90\n' % self.test)
		self.makefile.write ('\n')
